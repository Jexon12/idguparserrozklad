const CACHE_NAME = 'schedule-94762dc3860d';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/index2.html',
...
const VERSIONED_ASSETS = [
  ...
  "/js/notes.js?v=698a8fb5bd0a",
  "/js/occupancy.js?v=1960645bbd2d",
  ...
  "/js/search.js?v=88af43f4b9c7",
  "/js/session-admin.js?v=a5904f06cbd9",
  "/js/session-constructor.js?v=59514315132e",
  "/js/session-import.js?v=3dd1ff1cef17",
  "/js/session-page.js?v=072df060ea83",
  "/js/staff-portal.js?v=1e7e39408c24",
  "/js/utils.js?v=02db683800d8",
