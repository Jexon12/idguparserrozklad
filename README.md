...
- Публічний режим (`index.html`, `index2.html`, `session.html`) призначений лише для студентів і викладачів: розклад, «Мій день» та перегляд сесії.
- Службовий центр (`staff.html`) об'єднує інструменти диспетчерів, методистів і адміністраторів: Course Day, Week Builder, конструктор та адміністрування сесій.
